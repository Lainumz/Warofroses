<template>
    <div>
      <h1>Bibliography View</h1>
      <div class="video-container">
        <!-- Código para el reproductor de YouTube -->
        <iframe width="320" height="180" src="https://www.youtube.com/embed/8usSAMpuSVI" frameborder="0" allowfullscreen></iframe>
      </div>
      <!-- Enlaces clicables -->
      <ul>
